...
export type Faceta = {
  ...
  papel: string
  descripcion: string
  /** Cuál de los personajes 3D representa esta faceta. */
  modelo: 'paseo' | 'marina' | 'saiyan'
  desde: string
  hasta: string
...
export const FACETAS: Faceta[] = [
  {
    ...
    /* Antes era 'marina', la misma figura que Hotel Tech: con solo dos
       personajes para tres facetas, una se repetía. Esta lleva su propia
       pieza de Meshy, así que ninguna faceta comparte figura con otra. */
    modelo: 'saiyan',
    desde: '#00E5D1',
    hasta: '#2AC3FF',
    tinta: '#3BE0D0',
